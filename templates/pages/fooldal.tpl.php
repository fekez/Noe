...
<h3>Tevékenységünk</h3>
<img src="<?= $fooldal['njuhasz']['forras'] ?>" alt="<? $fooldal['njuhasz']['alt'] ?>">
...
<p>Tudjon meg többet rólunk: <a href="<?= '?oldal='.$oldalak['rolunk']['fajl'] ?>">Tovább</a></p>
<p>Link az eredeti oldalra: <a target="_blank" href="http://www.noeallatotthon.hu/">www.noeallatotthon.hu</a></p>
<iframe width="560" height="315" src="<?= $fooldal['youtube']['forras'] ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
<br><br><br>
<video width="560" height="315" controls>
  <source src="<?= $fooldal['video']['forras'] ?>" type="video/mp4">
</video>